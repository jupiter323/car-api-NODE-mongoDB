...
module.exports.connect = function(cb){
    var mongoHost = (nconf.get('MONGO_HOST') && nconf.get('MONGO_HOST') != '') ? nconf.get('MONGO_HOST') : "ds153978.mlab.com";
    var mongoPort = (nconf.get('MONGO_PORT') && nconf.get('MONGO_PORT') != '') ? nconf.get('MONGO_PORT') : 53978;
    var mongoConnectUrl = 'mongodb://' + 'jupiter123:jupiter12345@' + mongoHost + ':' + mongoPort + '/cars';
